...
public class AnimalController {
    ...
    public void loadAll() {
        ...
        System.out.println("PostConstruct başlatıldı..");
        this.animals = new HashMap<>();
        this.animals.put(1, new Animal(1, "kedi"));
    ...
    public List<Animal> getAnimals() {
        System.out.println("animal listesi için GET isteği atıldı..");
    ...
    public Animal getAnimal(@PathVariable("id") int id) {
        if (id < 0) {
            System.out.println(id + " tanımsızdır!!");
